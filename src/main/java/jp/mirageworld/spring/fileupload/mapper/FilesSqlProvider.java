...
import jp.mirageworld.spring.fileupload.entity.FilesExample.Criteria;
import jp.mirageworld.spring.fileupload.entity.FilesExample.Criterion;
...
public class FilesSqlProvider {
     ...
     * @mbg.generated
     */
    public String insertSelective(FilesWithBLOBs record) {
        SQL sql = new SQL();
        ...
        if (record.getFile() != null) {
            sql.VALUES("file", "#{file,jdbcType=BINARY}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExampleWithBLOBs(FilesExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FilesWithBLOBs record = (FilesWithBLOBs) parameter.get("record");
        ...
        if (record.getFile() != null) {
            sql.SET("file = #{record.file,jdbcType=BINARY}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(FilesWithBLOBs record) {
        SQL sql = new SQL();
        sql.UPDATE("files");
        
        if (record.getFile() != null) {
            sql.SET("file = #{file,jdbcType=BINARY}");
        }
